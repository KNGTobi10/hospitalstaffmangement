...
import 'editingshift_model.dart';
export 'editingshift_model.dart';

class EditingshiftWidget extends StatefulWidget {
  const EditingshiftWidget({
    super.key,
    required this.editshiftRef,
  });

  final DocumentReference? editshiftRef;

  @override
  State<EditingshiftWidget> createState() => _EditingshiftWidgetState();
}

class _EditingshiftWidgetState extends State<EditingshiftWidget> {
  late EditingshiftModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditingshiftModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<HopshiftsRecord>(
      stream: HopshiftsRecord.getDocument(widget.editshiftRef!),
      builder: (context, snapshot) {
        ...
        final editingshiftHopshiftsRecord = snapshot.data!;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        controller: _model.titlefieldTextController ??=
                          ...
                          text: editingshiftHopshiftsRecord.title,
                        ),
                      ...
                      child: FlutterFlowDropDown<String>(
                        controller: _model.dropDownValueController ??=
                          ...
                          _model.dropDownValue ??=
                              editingshiftHopshiftsRecord.license,
                        ),
                    ...
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(15.0, 15.0, 15.0, 8.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          Text(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.amountFieldTextController ??=
                                            TextEditingController(
                                      text: editingshiftHopshiftsRecord
                                          .payamount
                                          .toString(),
                                    ),
