...
import 'createshift_model.dart';
export 'createshift_model.dart';

class CreateshiftWidget extends StatefulWidget {
  const CreateshiftWidget({super.key});

  @override
  State<CreateshiftWidget> createState() => _CreateshiftWidgetState();
}

class _CreateshiftWidgetState extends State<CreateshiftWidget> {
  late CreateshiftModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateshiftModel());
